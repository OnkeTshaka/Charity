...
namespace Charity.Areas.Admin.Controllers
{
    public class RoleController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            List<ApplicationUser> Donor = new List<ApplicationUser>();
            List<ApplicationUser> OrganisationRep = new List<ApplicationUser>();
            ...
            foreach (var user in allUsers)
            {
                ...
                else if (userManager.IsInRole(user.Id, "Donor"))
                {
                    Donor.Add(user);
                }
                else if (userManager.IsInRole(user.Id, "OrganisationRep"))
                {
                    OrganisationRep.Add(user);
                }
            }

            UsersWithRoles.Admins = Admin;
            UsersWithRoles.Donors = Donor;
            UsersWithRoles.OrganisationRep = OrganisationRep;
        ...
        {
            if (RoleName.Equals("Admin") || RoleName.Equals("Donor") || RoleName.Equals("OrganisationRep"))
            {
